...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['maNV']) && isset($_POST['thangLuong']) && isset($_POST['namLuong'])) {
    try {
        ...
        if (!$result) {
            ...
            $luongTong = $result['luongCoBan'] + $result['tienThuong'];
            $salaryMessage = "Tổng lương của nhân viên là " . number_format($luongTong, 2) . " VNĐ";
        }
    } catch(PDOException $e) {
...
<body>
    ...
    <div class="search-container">
        <?php if ($salaryMessage): ?>
            <p class="salary-message"><?php echo htmlspecialchars($salaryMessage); ?></p>
        <?php endif; ?>
        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <button type="submit" class="calculate-button">Tính lương</button>
        </form>
    </div>
    ...
    <?php if ($result): ?>
        ...
        <table>
            ...
            <tr>
                ...
                <td><?php echo number_format($luongTong, 2); ?></td>
            </tr>
        </table>
    <?php endif; ?>
